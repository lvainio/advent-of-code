...
final class AocClient {
    ...
    public void submitAnswer(final int year, final int day, final int part) throws IOException, InterruptedException {
    ...
    private String fetchInputFromApi(final int year, final int day) throws IOException, InterruptedException {
    ...
    private void submitAnswerToApi(final int year, final int day, final int part, final String answer) throws IOException, InterruptedException {
