...
class DirectionTest {
  ...
  void testTurnRightInvalidAngles(int invalidAngle) {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> Direction.EAST.turnRight(invalidAngle));
  }
  ...
  void testTurnLeftInvalidAngles(int invalidAngle) {
    IllegalArgumentException exception =
        assertThrows(IllegalArgumentException.class, () -> Direction.EAST.turnLeft(invalidAngle));
  }
