    ...
    private record Rectangle(Location loc1, Location loc2) {
        ...
        public boolean intersects(final Line line) {
            ...
            if (line.start.col == line.end.col) {
                return line.start.col > rectMinCol && line.start.col < rectMaxCol &&
                        lineMaxRow > rectMinRow && lineMinRow < rectMaxRow;
            } else {
                return line.start.row > rectMinRow && line.start.row < rectMaxRow &&
                        lineMaxCol > rectMinCol && lineMinCol < rectMaxCol;
            }
        }
    }
