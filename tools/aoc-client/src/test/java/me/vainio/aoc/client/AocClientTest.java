...
class AocClientTest {
  ...
  @Mock private AocCache mockCache;
  ...
  @Test
  void fetchInputWhenInputAlreadyCachedShouldNotFetchFromApi()
  ...
  @Test
  void submitAnswerWhenAnswerNotCachedShouldNotSubmitToApi()
      throws IOException, InterruptedException {
    ...
    verify(mockCache, never())
        .getAnswer(any(Integer.class), any(Integer.class), any(Integer.class));
    verify(mockHttpClient, never()).send(any(), any());
  }
