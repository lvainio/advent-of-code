...
public class Solver extends AbstractSolver {
  ...
  public String solvePart1() {
    ...
    int minCost = allPaths.stream().mapToInt(this::computeCost).min().orElse(Integer.MAX_VALUE);
  ...
  public String solvePart2() {
    ...
    int maxCost = allPaths.stream().mapToInt(this::computeCost).max().orElse(Integer.MAX_VALUE);

    return Integer.toString(maxCost);
  }

  public void generateAllPaths(
      List<String> path, Set<String> citiesLeft, List<List<String>> allPaths) {
